...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/includes/Files/',
            'upload_url' => $this->get_full_url().'/includes/Files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    public function getFileProp() {
        return $this->get_upload_data($this->options['param_name']);
    }
